	...
	<div class="panel panel-info">
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-info" style="background-color: #568435" data-toggle="modal" data-target="#nuevoMO"><span class="glyphicon glyphicon-plus" ></span> Agregar Mano de Obra </button>
			</div>
		...
		<div class="panel-body">
			...
			<?php
			include("modal/registro_MO.php");
			include("modal/editar_MO.php");
			?>
...
$( "#editar_producto" ).submit(function( event ) {
  ...
  event.preventDefault();
	...
	function obtener_datos(id){
			...
			var detalles = $("#detalles"+id).val();
			var des = $("#des"+id).val();


			$("#mod_id").val(id);
			$("#mod_labores").val(labores);
			$("#mod_detalles").val(detalles);
			$("#mod_des").val(des);
