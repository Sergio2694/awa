<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE producto SET nombre_Producto='".$nombre."', descripcion_Producto='".$descripcion_Producto."', casa_Comercial='".$casa_comercial."',
		IA='".$IA."', presentacion='".$presentacion."', precio='".$precio."', uso_Tecnico='".$uso_tecnico."'
