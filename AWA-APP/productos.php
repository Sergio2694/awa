	...
	<div class="panel panel-info ">
		<div class="panel-heading">
			<div class="btn-group pull-right">
				<button type='button' class="btn btn-info" style="background-color: #568435" onclick="location='reporte/index.php'" ><span class="glyphicon glyphicon-plus" ></span> Descargar </button>
			</div>
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-info" style="background-color: #568435" data-toggle="modal" data-target="#nuevoProducto"><span class="glyphicon glyphicon-plus" ></span> Producto Nuevo </button>
			</div>
		...
		<div class="panel-body">
			...
			<form class="form-horizontal" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Productos" onkeyup='load(1);'>
							</div>
							<div class="col-md-3">
